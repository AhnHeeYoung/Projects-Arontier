...
**1. 목적** : 삼성서울병원으로부터 받은 CK, DESMIN, LCA 염색된 각각의 Whole-Slide-Image(WSI)로 부터 **Image Registration & GAN 을 이용한 WSI 생성 알고리즘 개발** 및 **TSR (Tumor Stroma Ratio), TIL (Tumor infiltrating lymphocytes) 계측**
